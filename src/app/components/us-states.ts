...
// Helper function to convert array of state names to codes
export function getStateCodes(stateNames: string[]): string[] {
  return stateNames.map(name => getStateCode(name));
}
