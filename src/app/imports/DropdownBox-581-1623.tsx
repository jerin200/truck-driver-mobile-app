import svgPaths from "./svg-t2b68nz6ct";
...
export default function DropdownBox() {
  return (
    <div className="bg-white content-stretch flex gap-[8px] items-center px-[16px] py-[12px] relative rounded-[6px] size-full" data-name="Dropdown box">
      ...
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px min-w-px not-italic relative text-[#717182] text-[14px] whitespace-pre-wrap">Select type</p>
