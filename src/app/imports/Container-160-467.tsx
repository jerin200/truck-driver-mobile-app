import svgPaths from "./svg-2spubxy7rr";
...
function Paragraph() {
  return (
    <div className="absolute h-[15.007px] left-0 top-0 w-[80.088px]" data-name="Paragraph">
      <p className="absolute font-semibold leading-[15px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.11px] uppercase">Trip Start</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[19.992px] left-0 top-[15.01px] w-[80.088px]" data-name="Paragraph">
      <p className="absolute font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] text-nowrap top-[0.11px]">2024-12-05</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="absolute h-[15.007px] left-0 top-0 w-[76.851px]" data-name="Paragraph">
      <p className="absolute font-semibold leading-[15px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.11px] uppercase">Trip End</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="absolute h-[19.992px] left-0 top-[15.01px] w-[76.851px]" data-name="Paragraph">
      <p className="absolute font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] text-nowrap top-[0.11px]">2024-12-15</p>
    </div>
  );
}
...
export default function Container() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative size-full" data-name="Container">
      <Card />
      <Card1 />
    </div>
  );
