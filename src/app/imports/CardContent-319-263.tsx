import svgPaths from "./svg-1dakj0og4t";

function Text() {
  return <div className="absolute bg-[rgba(0,201,80,0.23)] left-[-0.99px] rounded-[39602500px] size-[12px] top-[2.01px]" data-name="Text" />;
}

function Text1() {
  return <div className="absolute bg-[#05df72] left-[-5px] opacity-0 rounded-[39602500px] size-[19.99px] top-[-5px]" data-name="Text" />;
}

function Text2() {
  return <div className="absolute bg-[#00c950] left-[2.01px] rounded-[39602500px] size-[6px] top-[2.01px]" data-name="Text" />;
}
...
function Text4() {
  return (
    <div className="content-stretch flex h-[16.007px] items-start relative shrink-0 w-[100.358px]" data-name="Text">
      <p className="css-ew64yg font-bold leading-[16px] not-italic relative shrink-0 text-[12px] text-white tracking-[0.6px] uppercase">In Transit</p>
    </div>
  );
}
...
function Container1() {
  return <div className="h-[15px] shrink-0 w-[85px]" data-name="Container" />;
}
  ...
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative">
        <p className="css-ew64yg font-normal leading-[16px] not-italic relative shrink-0 text-[#5f6269] text-[0px] text-[12px]">
  ...
  return (
    <div className="relative shrink-0 size-[11.987px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.9869 11.9869">
        <g clipPath="url(#clip0_314_397)" id="Icon">
...
function Badge() {
  return (
    <div className="bg-[#dbeafe] content-stretch flex gap-[4px] h-[23.974px] items-center justify-center overflow-clip px-[12px] py-[4px] relative rounded-[8px] shrink-0" data-name="Badge">
      <Icon />
      <p className="css-ew64yg font-medium leading-[16px] not-italic relative shrink-0 text-[#2383f8] text-[12px]">In Transit</p>
    </div>
  );
}
...
function PermitInfo() {
  return (
    <div className="bg-[#f7faff] relative shrink-0 w-full" data-name="Permit Info">
      <div aria-hidden="true" className="absolute border-[#eff0f3] border-solid border-t-[1.108px] inset-0 pointer-events-none" />
...
function Text6() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative">
        <p className="css-ew64yg font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] text-right">New York, NY</p>
      </div>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="content-stretch flex flex-col gap-[3px] items-start justify-center relative shrink-0" data-name="Container">
      <p className="css-ew64yg font-normal leading-[16px] not-italic relative shrink-0 text-[#4a5565] text-[12px] uppercase">Origin</p>
      <Text6 />
      <p className="css-ew64yg font-medium leading-[16px] not-italic relative shrink-0 text-[#4a5565] text-[12px]">12-05-2025</p>
    </div>
  );
}
...
function Text7() {
  return (
    <div className="content-stretch flex h-[16.007px] items-start relative shrink-0 w-[154.299px]" data-name="Text">
      <p className="css-ew64yg font-semibold leading-[16px] not-italic relative shrink-0 text-[#06c] text-[12px] text-center">Richmond, VA (I-95 South)</p>
    </div>
  );
}
...
function Text8() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative">
        <p className="css-ew64yg font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] text-right">Miami, FL</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="content-stretch flex flex-col gap-[3px] items-end relative shrink-0" data-name="Container">
      <p className="css-ew64yg font-normal leading-[16px] not-italic relative shrink-0 text-[#4a5565] text-[12px] uppercase">Destination</p>
      <Text8 />
      <p className="css-ew64yg font-medium leading-[16px] not-italic relative shrink-0 text-[#4a5565] text-[12px] text-right">12-15-2025</p>
    </div>
  );
}
...
function Container8() {
  return <div className="bg-[#00a63e] h-[5.993px] rounded-[39602500px] shrink-0 w-full" data-name="Container" />;
}

function Container9() {
  return (
    <div className="bg-[#d6dbe6] h-[5.993px] relative rounded-[39602500px] shrink-0 w-full" data-name="Container">
  ...
  return (
    <div className="h-[15.993px] relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex h-full items-start relative">
        <p className="css-ew64yg font-medium leading-[16px] not-italic relative shrink-0 text-[#4a5565] text-[12px] tracking-[0.6px] uppercase">Permit(s):</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#ecfdf3] relative rounded-[5px] shrink-0 w-[36px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[13.108px] py-[7.108px] relative rounded-[inherit] w-full">
        <p className="css-ew64yg font-medium leading-[16px] not-italic relative shrink-0 text-[#067647] text-[12px]">NY</p>
      </div>
...
function Badge2() {
  return (
    <div className="bg-[#eff8ff] relative rounded-[5px] shrink-0 w-[35.639px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[13.108px] py-[7.108px] relative rounded-[inherit] w-full">
        <p className="css-ew64yg font-medium leading-[16px] not-italic relative shrink-0 text-[#2563eb] text-[12px]">NJ</p>
      </div>
...
function Badge3() {
  return (
    <div className="bg-[#fef3f2] relative rounded-[5px] shrink-0 w-[35.639px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[13.108px] py-[7.108px] relative rounded-[inherit] w-full">
        <p className="css-ew64yg font-medium leading-[16px] not-italic relative shrink-0 text-[#b42318] text-[12px]">PA</p>
      </div>
...
function Badge4() {
  return (
    <div className="bg-[#ecfdf3] relative rounded-[5px] shrink-0 w-[35.639px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[13.108px] py-[7.108px] relative rounded-[inherit] w-full">
        <p className="css-ew64yg font-medium leading-[16px] not-italic relative shrink-0 text-[#067647] text-[12px]">CT</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#abefc6] border-[1.108px] border-solid inset-0 pointer-events-none rounded-[5px]" />
    </div>
  );
...
function Badge5() {
  return (
    <div className="bg-[#eff8ff] relative rounded-[5px] shrink-0 w-[35.639px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[13.108px] py-[7.108px] relative rounded-[inherit] w-full">
        <p className="css-ew64yg font-medium leading-[16px] not-italic relative shrink-0 text-[#2563eb] text-[12px]">MA</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#bfdbfe] border-[1.108px] border-solid inset-0 pointer-events-none rounded-[5px]" />
    </div>
  );
...
function Badge6() {
  return (
    <div className="bg-[#ecfdf3] relative rounded-[5px] shrink-0 w-[35.639px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[13.108px] py-[7.108px] relative rounded-[inherit] w-full">
        <p className="css-ew64yg font-medium leading-[16px] not-italic relative shrink-0 text-[#067647] text-[12px]">MD</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#abefc6] border-[1.108px] border-solid inset-0 pointer-events-none rounded-[5px]" />
    </div>
  );
  ...
  return (
    <div className="bg-[#f9f9f9] h-[30.216px] relative rounded-[5px] shrink-0 w-[35.639px]" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[17px] py-[8px] relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-semibold leading-[16px] not-italic relative shrink-0 text-[#484848] text-[12px]">+5</p>
      </div>
    ...
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[8px]" data-name="Button">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[9px] items-center justify-center px-[55px] py-[12px] relative w-full">
          <Icon1 />
          <p className="css-ew64yg font-medium leading-[16px] not-italic relative shrink-0 text-[#06c] text-[14px] text-center">Download Permit(s)</p>
        </div>
      </div>
    </div>
  );
...
function Button1() {
  return (
    <div className="bg-white content-stretch flex gap-[8px] h-[40px] items-center justify-center px-[20px] py-[12px] relative rounded-[8px] shrink-0" data-name="button">
      ...
      <div className="capitalize css-g0mm18 flex flex-col font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#1a1a1a] text-[14px]">
        <p className="css-ew64yg leading-[normal]">Details</p>
      </div>
      <RightIcon />
    </div>
  );
