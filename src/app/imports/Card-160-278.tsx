import svgPaths from "./svg-3kjyofh18w";
  ...
  return (
    <div className="h-[19.992px] relative shrink-0 w-[132.603px]" data-name="CardTitle">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-semibold leading-[20px] left-0 not-italic text-[#101828] text-[14px] text-nowrap top-[0.11px]">General Information</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="absolute h-[15.007px] left-0 top-0 w-[170.492px]" data-name="Paragraph">
      <p className="absolute font-semibold leading-[15px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.11px] uppercase">Permit Type</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[19.992px] left-0 top-[15.01px] w-[170.492px]" data-name="Paragraph">
      <p className="absolute capitalize font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] text-nowrap top-[0.11px]">Oversize</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="absolute h-[15.007px] left-0 top-0 w-[170.492px]" data-name="Paragraph">
      <p className="absolute font-semibold leading-[15px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.11px] uppercase">Duration</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="absolute h-[19.992px] left-0 top-[15.01px] w-[170.492px]" data-name="Paragraph">
      <p className="absolute font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-[0.11px] w-[46px]">5 Days</p>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="h-[15.007px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-semibold leading-[15px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.11px] uppercase">Reference</p>
    </div>
  );
}
