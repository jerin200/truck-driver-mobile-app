import svgPaths from "./svg-77soggv421";
  ...
  return (
    <div className="h-[19.992px] relative shrink-0 w-[82.511px]" data-name="CardTitle">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-medium leading-[20px] left-0 not-italic text-[#101828] text-[14px] text-nowrap top-[0.11px]">Load Details</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="absolute h-[15.007px] left-0 top-0 w-[170.492px]" data-name="Paragraph">
      <p className="absolute font-semibold leading-[15px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.11px] uppercase">Type</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[19.992px] left-0 top-[15.01px] w-[170.492px]" data-name="Paragraph">
      <p className="absolute font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] text-nowrap top-[0.11px]">Excavator</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="absolute h-[15.007px] left-0 top-0 w-[170.492px]" data-name="Paragraph">
      <p className="absolute font-semibold leading-[15px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.11px] uppercase">Weight</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="absolute h-[19.992px] left-0 top-[15.01px] w-[170.492px]" data-name="Paragraph">
      <p className="absolute font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] text-nowrap top-[0.11px]">45,000 lbs</p>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="absolute h-[15.007px] left-0 top-0 w-[170.492px]" data-name="Paragraph">
      <p className="absolute font-semibold leading-[15px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.11px] uppercase">Divisible</p>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="absolute h-[19.992px] left-0 top-[15.01px] w-[170.492px]" data-name="Paragraph">
      <p className="absolute capitalize font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] text-nowrap top-[0.11px]">No</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="absolute h-[15.007px] left-0 top-0 w-[170.492px]" data-name="Paragraph">
      <p className="absolute font-semibold leading-[15px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.11px] uppercase">Self-Propelled</p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="absolute h-[19.992px] left-0 top-[15.01px] w-[170.492px]" data-name="Paragraph">
      <p className="absolute capitalize font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] text-nowrap top-[0.11px]">Yes</p>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="h-[15.007px] relative shrink-0 w-[356.977px]" data-name="Paragraph">
      <p className="absolute font-semibold leading-[15px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.11px] uppercase">Commodity</p>
    </div>
  );
}
...
function Paragraph9() {
  return (
    <div className="h-[19.992px] relative shrink-0 w-[356.977px]" data-name="Paragraph">
      <p className="absolute font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] text-nowrap top-[0.11px]">Class I - Other</p>
    </div>
  );
}
...
function Paragraph10() {
  return (
    <div className="h-[15.007px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-semibold leading-[15px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.11px] uppercase">Description</p>
    </div>
  );
}
...
function Paragraph11() {
  return (
    <div className="h-[19.992px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] text-nowrap top-[0.11px]">Heavy machinery transport</p>
    </div>
  );
}
...
function Paragraph12() {
  return (
    <div className="h-[15.007px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-semibold leading-[15px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.11px] uppercase">Dimensions</p>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="absolute content-stretch flex h-[15.993px] items-start left-0 top-0 w-[104.926px]" data-name="Container">
      <p className="basis-0 font-bold grow leading-[16px] min-h-px min-w-px not-italic relative shrink-0 text-[#101828] text-[14px] text-center">20 ft</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="absolute h-[15.007px] left-0 top-[15.99px] w-[104.926px]" data-name="Container">
      <p className="absolute font-normal leading-[15px] left-[52.93px] not-italic text-[#4a5565] text-[12px] text-center text-nowrap top-[0.11px] translate-x-[-50%]">Length</p>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="absolute content-stretch flex h-[15.993px] items-start left-0 top-0 w-[103.818px]" data-name="Container">
      <p className="basis-0 font-bold grow leading-[16px] min-h-px min-w-px not-italic relative shrink-0 text-[#101828] text-[14px] text-center">8.5 ft</p>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="absolute h-[15.007px] left-0 top-[15.99px] w-[103.818px]" data-name="Container">
      <p className="absolute font-normal leading-[15px] left-[52.04px] not-italic text-[#4a5565] text-[12px] text-center text-nowrap top-[0.11px] translate-x-[-50%]">Width</p>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="absolute content-stretch flex h-[15.993px] items-start left-0 top-0 w-[103.818px]" data-name="Container">
      <p className="basis-0 font-bold grow leading-[16px] min-h-px min-w-px not-italic relative shrink-0 text-[#101828] text-[14px] text-center">10 ft</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="absolute h-[15.007px] left-0 top-[15.99px] w-[103.818px]" data-name="Container">
      <p className="absolute font-normal leading-[15px] left-[52.3px] not-italic text-[#4a5565] text-[12px] text-center text-nowrap top-[0.11px] translate-x-[-50%]">Height</p>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="h-[15.993px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-bold leading-[16px] left-[80.86px] not-italic text-[#101828] text-[14px] text-center text-nowrap top-0 translate-x-[-50%]">0 ft</p>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="h-[15.007px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-normal leading-[15px] left-[81.4px] not-italic text-[#4a5565] text-[12px] text-center text-nowrap top-[0.11px] translate-x-[-50%]">Front Overhang</p>
    </div>
  );
}
...
function Container17() {
  return (
    <div className="h-[15.993px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-bold leading-[16px] left-[81.09px] not-italic text-[#101828] text-[14px] text-center text-nowrap top-0 translate-x-[-50%]">2 ft</p>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="h-[15.007px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-normal leading-[15px] left-[80.49px] not-italic text-[#4a5565] text-[12px] text-center text-nowrap top-[0.11px] translate-x-[-50%]">Rear Overhang</p>
    </div>
  );
}
...
function Paragraph13() {
  return (
    <div className="h-[15.007px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-semibold leading-[15px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[0.11px] uppercase">Load Diagram</p>
    </div>
  );
}
...
function Paragraph14() {
  return (
    <div className="content-stretch flex h-[15.993px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="basis-0 font-medium grow leading-[16px] min-h-px min-w-px not-italic relative shrink-0 text-[#101828] text-[12px]">diagram-v1.pdf</p>
    </div>
  );
}
...
function Paragraph15() {
  return (
    <div className="h-[15.007px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-normal leading-[15px] left-0 not-italic text-[#4a5565] text-[10px] text-nowrap top-[0.11px]">2.4 MB • PDF</p>
    </div>
  );
}
