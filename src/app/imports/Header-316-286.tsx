import svgPaths from "./svg-v8lssgjolq";
...
function MobileTopBar() {
  return (
    <div className="content-stretch flex h-[61px] items-start justify-between p-[20px] relative shrink-0 w-[440px]" data-name="MobileTopBar">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[16px] text-nowrap text-right text-white tracking-[-0.32px]">11:39</p>
      <StatusIcons />
    </div>
  );
}
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pb-[16px] pt-[12px] px-[16px] relative w-full">
          ...
          <div className="basis-0 flex flex-col font-['Inter:Bold',sans-serif] font-bold grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[20px] text-center text-white">
            <p className="leading-[normal]">NY - FL</p>
          </div>
          <div className="flex items-center justify-center relative shrink-0">
            <div className="flex-none rotate-[180deg]">
              <BackButton1 />
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Header" style={{ backgroundImage: "linear-gradient(109.083deg, rgb(11, 18, 21) 0.3559%, rgb(48, 48, 49) 106.2%)" }}>
      ...
      <div className="absolute left-[-480px] size-[1430px] top-[-617px]" data-name="Background image">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgBackgroundImage1} />
      </div>
      <MobileTopBar />
      <Title />
      <BackgroundGraphics />
